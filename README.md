...
- 학생 4자리 PIN도 원문이 아닌 보안 해시로 저장합니다.
...
- 학생 출석/퇴실 처리
- 학생/교사 로그인
- 학생 로그인과 첫 기기 등록 시 학번, 이름, 4자리 PIN 확인
- 한 기기는 한 학생에게만 등록
- 학생 한 명당 최대 2개 기기 등록
...
기존 학생 계정의 `password_hash='unused'`는 자동 PIN으로 바뀌지 않습니다. 최신 스키마 적용 후 교사 화면의 학생 수정에서 각 학생에게 새 PIN 4자리를 설정해야 로그인할 수 있습니다. 공통 PIN이나 학번 기반 PIN은 사용하지 않습니다.
